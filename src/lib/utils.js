...
export const featureItems = [
  {
    icon: <MdSavedSearch className="w-10 h-10 text-black rounded-2xl" />,
    title: "Quick Search",
    description: "Find repositories instantly by entering a GitHub username.",
    gradient: "from-teal-500/10 to-cyan-500/10",
  },
  {
    icon: <FaGithub className="w-10 h-10 text-black rounded-2xl" />,
  ...
  {
    icon: (
      <MdOutlineTipsAndUpdates className="w-10 h-10 text-black rounded-2xl" />
    ),
    title: "Stay Updated",
